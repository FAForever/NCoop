...
-- path to the nomads coop repository
dev_pathnomads = 'G:\\GITS\\NCoop'
...
-- we'll get all kinds of issues (simplest check: is there a weird icon in the campaign manager window? If yes then there are issues).
